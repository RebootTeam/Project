...
<body>
   ...
   <!-- 로그인정보 -->
    ...
    <tr>
      <td colspan="2"><b>비밀번호 : <input type="password" value="${pdto.password}" size=50 maxlength="20" /></b></td>
    </tr>
    <tr>
    ...
    <tr>
   <td><b>생년월일 : <input type="date" value="${pdto.bday}" /></b></td>
   <td><b>
   <form action="process.jsp" method="post">
  <label for="phone">연락처:</label>
  <input type="tel" id="phone" value="${pdto.pnum}" name="phone" onkeyup="insertHyphen(this)" maxlength="11" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" placeholder="예)010-1234-5678" required>
   </form>
   </b>
   </td>
    </tr>
    <tr>
   <td colspan="2"><b>주소 : <input type="text" value="${pdto.ad}" size=80 maxlength="50" /></b></td>
    </tr>
</table>
     <button type="submit" onclick="location.href='Main.jsp'" style="background-color: #4169E1">수정 하기</button>
     </form>
     </div>
