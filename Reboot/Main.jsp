...
<body>
	<div class="sidebar">
		<ul>
			<li>
				<a href="../rebootServlet/mypage.do?id=${id}">.
   ...
   <!-- 로그인정보 -->
     <div class="center-header">
        <h2><a href="#" onclick="handleSidebar1click(4)">${id}</a></h2>
     </div>
    ...
    <tr>
      <td><b>사번 : <input type="text" pattern="[0-9]{6}" maxlength="7" value="${dto.id}" disabled /></b></td>
      <td><b>이름 : <input type="text" value="${dto.name}" disabled/></b></td>
    </tr>
    <tr>
      <td colspan="2"><b>비밀번호 : <input type="password" size=50 maxlength="20" value="${dto.password}" disabled/></b></td>
    </tr>
    <tr>
      <td><b>입사일 : <input type="date" value="${dto.in_d}" disabled/></b></td>
      <td><b>퇴사일 : <input type="date" value="${dto.out_d}" disabled /></b></td>
    </tr>
    <tr>
      <td><b>부서명 : <select name="team" value="${dto.deptn}"disabled>
          <option value="0">업무팀</option>
          <option value="1">인사팀</option>
          <option value="2">시스템팀</option>
                   </select></b></td>
      <td><b>직급 : <select name="grade" value="${dto.grade}" disabled>
      <option value="a">사원</option>
          <option value="b">팀장</option>
          <option value="c">사장</option></b></td>
    </tr>
    <tr>
   <td><b>생년월일 : <input type="date" value="${dto.bday}" disabled /></b></td>
   <td><b>
   <form action="process.jsp" method="post">
  <label for="phone">연락처:</label>
  <input type="tel" id="phone" name="phone" onkeyup="insertHyphen(this)" maxlength="11" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" placeholder="예)010-1234-5678" value="${dto.pnum}" disabled required>
   </form>
   </b>
   </td>
    </tr>
