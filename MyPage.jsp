...
<body>
	<div class="sidebar">
		<ul>
			<li>
				<a href="../rebootServlet/mypage.do?id=${dto.id}">
  ...
  <input type="tel" id="phone" name="phone" onkeyup="insertHyphen(this)" maxlength="11" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" placeholder="예)010-1234-5678" value="${dto.pnum}" disabled required>
    ...
    <tr>
   <td colspan="2"><b>주소 : <input type="text" size=80 maxlength="50" value="${dto.ad}" disabled /></b></td>
    </tr>
</table>
     <button type="button" onclick="location.href='MyPageEdit.jsp'" style="background-color: #4169E1">수정하기</button>
     </form>
     </div>
   <script>
